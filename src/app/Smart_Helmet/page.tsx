...
//                   <div className="h-24 w-16 rounded-full bg-gradient-to-b from-zinc-400/40 via-zinc-800 to-black relative">
//                     <div className="absolute -top-8 left-1/2 h-10 w-10 -translate-x-1/2 rounded-full bg-gradient-to-b from-zinc-200 via-zinc-700 to-black shadow-[0_0_25px_rgba(250,204,21,0.4)]" />
//                     <div className="absolute -top-7 left-1/2 h-12 w-12 -translate-x-1/2 rounded-full border border-yellow-300/50" />
//                     <div className="absolute right-[-18px] top-4 h-6 w-6 rounded-md bg-yellow-400/20 border border-yellow-400/60" />
//                     <div className="absolute left-[-18px] top-10 h-4 w-4 rounded-md bg-emerald-400/20 border border-emerald-400/60" />
//                   </div>
//                 </div>
//               </div>
//             </motion.div>
...
//     {/* Right: generic configurable dashboard mock */}
          ...
          <div className="mt-10 grid gap-10 md:grid-cols-2">
            ...
            <motion.div {...fadeIn}>
              <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#18181b] via-[#020617] to-black p-5 shadow-[0_28px_90px_rgba(0,0,0,0.95)]">
                ...
                {/* simple figure mock */}
                <div className="mt-6 flex items-end justify-center">
                  <div className="relative h-24 w-16 rounded-full bg-gradient-to-b from-zinc-400/40 via-zinc-800 to-black">
                    <div className="absolute -top-8 left-1/2 h-10 w-10 -translate-x-1/2 rounded-full bg-gradient-to-b from-zinc-200 via-zinc-700 to-black shadow-[0_0_25px_rgba(250,204,21,0.4)]" />
                    <div className="absolute -top-7 left-1/2 h-12 w-12 -translate-x-1/2 rounded-full border border-yellow-300/50" />
                    <div className="absolute right-[-18px] top-4 h-6 w-6 rounded-md bg-yellow-400/20 border border-yellow-400/60" />
                    <div className="absolute left-[-18px] top-10 h-4 w-4 rounded-md bg-emerald-400/20 border border-emerald-400/60" />
