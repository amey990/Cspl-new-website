...
import CNMSTopologyImage from '../../assets/products/cnms-topology.png';
  ...
  <Link href="/CPAL" className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-sm text-white/80 hover:border-white/20 hover:bg-white/[0.05]">
    ...
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path d="M9 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        {/* --- Smart Helmet Section (TEMPORARILY COMMENTED OUT) ---
        ...
        --- END Smart Helmet Section --- */}

        {/* --- CNMS Section (replacing Smart Helmet temporarily) --- */}
        <div className="relative mt-12 pt-12 md:pt-16">
          <div className="grid gap-12 md:grid-cols-2 items-center">
            {/* Left side - Content */}
            <motion.div
              ...
              className="flex flex-col"
            >
              {/* Network Management Chip */}
              <div className="mb-6">
                <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3 py-1 text-[13px] text-white/70">
                  <span className="h-2 w-2 rounded-full bg-[#9502A8] shadow-[0_0_14px_rgba(149,2,168,.6)]" />
                  Network Management
                </span>
              </div>
              ...
              <div className="mb-8 space-y-3">
                <div className="flex items-center gap-3">
                  <div className="h-1 w-1 rounded-full bg-[#9502A8]" />
                  <span className="text-[15px] text-white/80">Topology-wide Visibility</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="h-1 w-1 rounded-full bg-[#9502A8]" />
                  <span className="text-[15px] text-white/80">Real-time Health Scores</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="h-1 w-1 rounded-full bg-[#9502A8]" />
                  <span className="text-[15px] text-white/80">Intelligent Alerts</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="h-1 w-1 rounded-full bg-[#9502A8]" />
                  <span className="text-[15px] text-white/80">Historical Trend Analysis</span>
                </div>
              </div>
            ...
            {/* Right side - CNMS Dashboard Images (stacked 3D) */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true, amount: 0.35 }}
              ...
              className="relative flex items-center justify-center"
            >
              <div className="relative w-full max-w-[600px] pb-12" style={{ perspective: '1200px' }}>
                ...
                />
                {/* Overlay topology image at 3D angle */}
                <Image
                  src={CNMSTopologyImage}
                  alt="CNMS topology view"
                  quality={95}
                  className="absolute -bottom-6 -right-4 w-[72%] rounded-2xl border border-white/10 shadow-[0_28px_90px_rgba(0,0,0,0.95)]"
                  style={{
