// // src/app/components/PartnersHeroField.tsx
// 'use client';
...
// // === icon imports (same set you used for IconCubesField / Verticals hero) ===
...
// const partnerTypes = [
//   { label: 'Cloud & Infra', dot: 'bg-sky-400' },
//   { label: 'Broadcast & Media', dot: 'bg-fuchsia-400' },
//   { label: 'Network OEMs', dot: 'bg-emerald-400' },
//   { label: 'System Integrators', dot: 'bg-amber-400' },
//   { label: 'Analytics & AI', dot: 'bg-cyan-400' },
// ];

// export default function PartnersHeroField() {
//   const ROWS = 4;
//   const COLS = 10;
...
//     // Fisher–Yates shuffle for randomised appear order
...
//   return (
//     <section className="relative min-h-screen w-full overflow-hidden bg-[#050506]">
//       {/* === Background cube grid (same feel as Verticals hero) === */}
...
//                           src={icon.src}
//                           alt={icon.alt}
//                           className="h-7 w-7 opacity-70 md:h-8 md:w-8"
//                         />
//                       </div>
//                     </motion.div>
//                   );
...
//       {/* === Foreground central cube (same placement as Verticals hero) === */}
//       <motion.div
//         className="pointer-events-none absolute left-1/2 top-[38%] z-20 -translate-x-1/2 -translate-y-1/2 md:top-[35%]"
...
//       >
//         <div
//           className="relative flex items-center justify-center overflow-hidden rounded-3xl border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.9)]"
//           style={{
//             width: '150px',
//             height: '150px',
//             background:
//               'radial-gradient(circle at 30% 20%, rgba(59,130,246,0.35), transparent 55%), radial-gradient(circle at 70% 80%, rgba(56,189,248,0.3), transparent 60%), #141515',
//           }}
//         >
//           <Handshake className="h-16 w-16 text-white" strokeWidth={1.6} />
//         </div>
//       </motion.div>

//       {/* === Centered chip, heading, subtext & partner type pills === */}
//       <div className="pointer-events-none absolute inset-x-0 top-[57%] z-10 flex flex-col items-center px-6 text-center md:top-[58%]">
//         {/* chip */}
//         <div className="inline-flex items-center rounded-full border border-cyan-400/40 bg-cyan-500/10 px-5 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-cyan-200">
//           Partners
//         </div>

//         {/* title */}
//         <h1
//           className="mt-5 max-w-4xl text-[40px] font-medium leading-tight text-white md:text-[54px]"
//           style={{
//             fontFamily:
...
//         <div className="mt-6 flex flex-wrap justify-center gap-3 text-[11px] md:text-xs">
//           {partnerTypes.map((p) => (
//             <div
//               key={p.label}
//               className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/40 px-4 py-1 text-slate-200"
//             >
...
//       {/* === Vignette overlays to match other heroes === */}
...
//       <div className="pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(to_right,rgba(0,0,0,1),rgba(0,0,0,0.85)_12%,rgba(0,0,0,0)_24%,rgba(0,0,0,0)_76%,rgba(0,0,0,0.85)_88%,rgba(0,0,0,1))]" />
//       <div className="pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(to_bottom,rgba(0,0,0,0.98)_0%,rgba(0,0,0,0.15)_20%,rgba(0,0,0,0.15)_45%,rgba(0,0,0,0.98)_100%)]" />
//     </section>
//   );
// }
