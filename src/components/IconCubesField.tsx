...
//       {/* Foreground hero cube (no logo, just the cube) */}
//       <motion.div
...
//       >
//         <div
//           className="rounded-3xl border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.9)]"
//           style={{
//             width: '150px',
//             height: '150px',
//             background:
...
//       {/* Vignette overlays (same tuned values) */}
//       <div className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0)_0%,rgba(0,0,0,0.6)_55%,rgba(0,0,0,0.95)_80%,rgba(0,0,0,1)_100%)]" />
...
//       <div className="pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(to_bottom,rgba(0,0,0,1),rgba(0,0,0,0.9)_6%,rgba(0,0,0,0)_16%,rgba(0,0,0,0)_64%,rgba(0,0,0,0.9)_94%,rgba(0,0,0,1))]" />
//     </div>
//   );
// }
