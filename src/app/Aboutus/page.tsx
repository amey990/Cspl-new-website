...
const PRESENCE_MARKERS: GlobeMarker[] = [
  ...
  { lat: 26.0667, lng: 50.5577, label: "Bahrain" },
  ...
  { lat: -35.2809, lng: 149.1300, label: "Canberra" },
  { lat: -4.1090, lng: 145.4180, label: "Papua New Guinea" },
].map(marker => ({
  ...marker,
  src: `https://ui-avatars.com/api/?name=${encodeURIComponent(marker.label!)}&background=random&color=fff&size=32&rounded=true&bold=true`
}));
          ...
          <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-16">
            ...
            >
              <div className="relative h-[400px] w-full sm:h-[500px]">
                <Globe3D markers={PRESENCE_MARKERS} />
              </div>
            </div>
          </div>
        </div>
