...
//     blurb:
//       'End-to-end networks and NOC-centric operations for telecom operators.',
//     accent: 'text-sky-300',
...
//     label: 'Government',
//     blurb:
//       'Nation-scale media and network infrastructure for public-sector projects.',
...
//               <p className="mt-4 text-sm leading-relaxed text-zinc-300 md:text-base">
//                 Broadcast industry in India is undergoing a shift in terms of
//                 technology on multiple fronts. Baseband and non-automated
//                 workflows are giving way to IP-based and automated flows. Newer
//                 HEVC compression standards reduce operational cost while
//                 maintaining quality.
//               </p>

//               <p className="mt-3 text-sm leading-relaxed text-zinc-300 md:text-base">
//                 Technologies like AI, AR and VR are spreading across the
//                 broadcast domain, while online platforms and OTT/IPTV services
//                 explode. Telcos, broadcasters, content producers and
//                 aggregators are all looking to modernise their chains end-to-end.
//               </p>

//               <p className="mt-3 text-sm leading-relaxed text-zinc-400 md:text-base">
//                 Commedia works closely with major broadcasters in India and
//                 abroad, from setting up satellite / cable channels to
...
//                       <span>
//                         SITC of turnkey projects, headend and teleport
//                         infrastructure.
//                       </span>
//                     </li>
//                     <li className="flex gap-2">
...
//                       <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-fuchsia-400" />
//                       <span>
//                         ENG cameras, newsroom control, online/offline graphics.
//                       </span>
//                     </li>
//                   </ul>
...
//                       <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-fuchsia-400" />
//                       <span>
//                         Compliance and SLAs across the transmission chain (QoS
//                         / QoE).
//                       </span>
//                     </li>
//                     <li className="flex gap-2">
//                       <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-fuchsia-400" />
//                       <span>
//                         Managed services for audits, playout, metadata tagging
//                         &amp; QC.
//                       </span>
//                     </li>
//                   </ul>
...
//         {/* ================================================================== */}
//         {/* ENTERPRISE – TEXT THEN CARD RIGHT                                */}
//         {/* ================================================================== */}
//         <section
//           id="enterprise"
//           className="mx-auto mt-24 max-w-6xl px-6 md:px-10 lg:px-16"
...
//               <p className="mt-4 text-sm leading-relaxed text-zinc-300 md:text-base">
//                 With the convergence of technologies, Commedia understands the
//                 evolving needs of growing enterprise companies. Diverse
//                 businesses now recognise the efficiency that modern IT and
//                 networking bring across functions – from collaboration and
//                 security to customer experience.
//               </p>

//               <p className="mt-3 text-sm leading-relaxed text-zinc-300 md:text-base">
//                 Commedia has been delivering round-the-clock projects where
//                 customers&apos; IT and enterprise infrastructure are
//                 mission-critical. We work with stacks from Dell, Cisco, AWS,
//                 HPE, Juniper, Avaya, Ruckus, SonicWall and more to provide
//                 seamless, high-end platforms.
//               </p>
...
//                       <span>
//                         SITC of wireless &amp; wired networking enterprise
//                         solutions.
//                       </span>
//                     </li>
//                     <li className="flex gap-2">
...
//                       <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-amber-400" />
//                       <span>
//                         SITC of auditoriums, meeting rooms and conference
//                         halls.
//                       </span>
//                     </li>
//                     <li className="flex gap-2">
...
//         {/* ================================================================== */}
//         {/* GOVERNMENT – TEXT THEN CARD LEFT                                 */}
//         {/* ================================================================== */}
//         <section
//           id="government"
//           className="mx-auto mt-24 max-w-6xl px-6 md:px-10 lg:px-16"
...
//               <p className="mt-4 text-sm leading-relaxed text-zinc-300 md:text-base">
//                 The Government of India has many departments under the Ministry
//                 of Information &amp; Broadcasting, Ministry of Telecom and
//                 Education, where rapid technology advancements create
//                 opportunities for diverse projects across domains.
//               </p>

//               <p className="mt-3 text-sm leading-relaxed text-zinc-300 md:text-base">
//                 Commedia has been working with government projects such as
//                 Prasar Bharti, All India Radio and ISRO since its inception. We
//                 focus on delivering robust, compliant infrastructure and
