...
import IndustryAnimation from '../../../assets/lottie/Industry.json';
import HelmetHero from '../../../assets/Smart_H.png';
  ...
  return (
    <main className="relative w-full overflow-hidden bg-[#010101]">
      ...
      <div className="relative z-10 pt-14 sm:pt-16 md:pt-20 pb-16 sm:pb-20 md:pb-24">
        ...
        {/* 0. TITLE BLOCK                                                      */}
        {/* ------------------------------------------------------------------ */}
        <motion.div {...fadeUp} className="mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
        ...
        {/* 1. HERO SECTION                                                     */}
        {/* ------------------------------------------------------------------ */}
        <section className="mt-10 sm:mt-14 md:mt-16 mx-auto flex max-w-6xl flex-col gap-10 sm:gap-12 px-5 sm:px-8 md:flex-row md:px-10 lg:px-16">
          {/* LEFT: Text */}
          <motion.div {...fadeUp} className="flex-1 space-y-4 sm:space-y-6 md:max-w-md">
            <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400/40 bg-yellow-400/5 px-3 sm:px-4 py-1 text-[10px] sm:text-xs font-medium uppercase tracking-[0.18em] text-yellow-300">
              <span className="h-2.5 w-3 sm:w-4 rounded-full bg-yellow-400 shadow-[0_0_12px_rgba(250,204,21,0.9)]" />
              <span>Smart Helmet</span>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4 text-sm text-slate-100/90">
              {[
                'Worker safety.',
                ...
                <div key={t} className="flex items-center gap-3 sm:gap-4">
                  <span className="h-8 sm:h-10 w-[2px] flex-shrink-0 bg-yellow-400" />
                  <span>{t}</span>
                </div>
              ))}
            </div>
          ...
          {/* RIGHT: Helmet hero image + floor grid */}
          <motion.div {...fadeIn} className="relative flex-1 md:flex-[0.6]">
            {/* 3D floor grid under the helmet */}
            <div
              className="pointer-events-none absolute inset-x-[-15%] sm:inset-x-[-25%] -bottom-24 sm:-bottom-36 flex justify-center"
              style={{ perspective: '1400px' }}
            >
              <div
                style={{
            ...
            <Image
              src={HelmetHero}
              alt="Smart Helmet 3D visualization"
              className="relative z-10 w-full h-auto scale-105 sm:scale-110"
              priority
              quality={100}
            />
          </motion.div>
        ...
        {/* 2. HOW IT WORKS                                                     */}
        {/* ------------------------------------------------------------------ */}
        <section className="mt-20 sm:mt-24 md:mt-28 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <div className="grid items-center gap-10 sm:gap-12 md:grid-cols-2">
            {/* LEFT: Text */}
            <motion.div {...fadeUp}>
              <p className="inline-flex items-center rounded-full border border-yellow-400/40 bg-yellow-400/5 px-3 sm:px-4 py-1 text-[10px] sm:text-xs font-medium uppercase tracking-[0.18em] text-yellow-300">
                How it works
              </p>
              ...
              <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-sm text-slate-100/90">
                {[
                  {
                    title: 'On-helmet sensors',
                    body: 'Gas, heart rate, proximity, motion and impact readings sampled in real time.',
                  },
                  {
                    title: 'Secure edge gateway',
                    body: 'Encrypted data uplink over wireless networks from field sites.',
                  },
                  {
                    title: 'AWS cloud pipeline',
                    body: 'Stream processing, enrichment and time-series storage for safety analytics.',
                  },
                  {
                    title: 'Safety portal',
                    body: 'Dashboards, alerts and investigations in a single browser-based workspace.',
                  },
                ].map((item) => (
            ...
            <motion.div {...fadeIn} className="flex justify-center">
              <div className="relative w-full max-w-xl rounded-2xl border border-white/10 bg-gradient-to-b from-[#141516] via-[#050506] to-black p-4 sm:p-6 shadow-[0_36px_120px_rgba(0,0,0,0.95)]">
                {/* Helmet box */}
                <div className="rounded-xl border border-yellow-400/40 bg-black/70 px-3 sm:px-4 py-2.5 sm:py-3 shadow-[0_0_25px_rgba(250,204,21,0.35)]">
                  <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.16em] text-yellow-300">
                    Device
                  </div>
                  <div className="mt-1 text-sm font-medium text-white">Smart Helmet</div>
                ...
                <div className="mt-3 sm:mt-4 flex items-center gap-2 sm:gap-3">
                  <div className="h-px flex-1 bg-gradient-to-r from-yellow-400 via-yellow-300 to-transparent" />
                  <span className="text-[9px] sm:text-[10px] text-yellow-200/80 whitespace-nowrap">Encrypted telemetry</span>
                </div>

                {/* Cloud box */}
                <div className="mt-3 rounded-xl border border-sky-400/30 bg-sky-400/5 px-3 sm:px-4 py-2.5 sm:py-3">
                  <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.16em] text-sky-300">
                    AWS Cloud
                  </div>
                  <div className="mt-1 text-sm font-medium text-white">Ingest &amp; processing</div>
                  <div className="mt-2 grid grid-cols-3 gap-1.5 sm:gap-2 text-[9px] sm:text-[11px] text-slate-300">
                    <div className="rounded-md bg-black/50 px-1.5 sm:px-2 py-1">IoT ingest</div>
                    <div className="rounded-md bg-black/50 px-1.5 sm:px-2 py-1">Stream processing</div>
                    <div className="rounded-md bg-black/50 px-1.5 sm:px-2 py-1">Time-series store</div>
                  </div>
                </div>

                <div className="mt-3 sm:mt-4 flex items-center gap-2 sm:gap-3">
                  <div className="h-px flex-1 bg-gradient-to-r from-sky-400 via-sky-300 to-transparent" />
                  <span className="text-[9px] sm:text-[10px] text-sky-200/80 whitespace-nowrap">APIs &amp; events</span>
                </div>

                {/* Portal box */}
                <div className="mt-3 rounded-xl border border-white/15 bg-black/70 px-3 sm:px-4 py-2.5 sm:py-3">
                  <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.16em] text-slate-300">
                    Safety portal
                  </div>
                  <div className="mt-2 grid grid-cols-3 gap-1.5 sm:gap-2 text-[9px] sm:text-[11px] text-slate-200">
                    <div className="rounded-md bg-white/5 px-1.5 sm:px-2 py-1 text-center">Live board</div>
                    <div className="rounded-md bg-white/5 px-1.5 sm:px-2 py-1 text-center">Alert feed</div>
                    <div className="rounded-md bg-white/5 px-1.5 sm:px-2 py-1 text-center">Incident view</div>
                  </div>
                </div>

                <div className="mt-3 sm:mt-4 text-[9px] sm:text-[11px] text-slate-400">
                  Fully managed, scalable pipeline from device to dashboard.
                </div>
              </div>
            </motion.div>
        ...
        {/* 3. LIVE SAFETY FEED DASHBOARD                                      */}
        {/* ------------------------------------------------------------------ */}
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <div className="grid items-center gap-10 sm:gap-12 md:grid-cols-2">
            {/* LEFT: Dashboard mock */}
            <motion.div {...fadeIn} className="flex justify-center">
              <div className="relative w-full max-w-xl rounded-2xl border border-white/10 bg-gradient-to-b from-[#171717] via-[#050505] to-black p-3 sm:p-4 md:p-5 shadow-[0_40px_130px_rgba(0,0,0,1)]">
                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                  <div className="flex gap-1.5">
                    <span className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-red-500/60" />
                    <span className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-yellow-400/60" />
                    <span className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-emerald-500/60" />
                  </div>
                  <div className="h-4 sm:h-5 w-24 sm:w-28 rounded-full bg-zinc-800/80" />
                </div>

                <div className="grid grid-cols-12 gap-2 sm:gap-3">
                  {/* left map block */}
                  <div className="col-span-5 rounded-xl bg-zinc-900/80 p-2 sm:p-3">
                    <div className="mb-2 flex items-center justify-between">
                      <div className="h-2.5 sm:h-3 w-12 sm:w-14 rounded-md bg-zinc-700" />
                      <div className="h-2.5 sm:h-3 w-8 sm:w-10 rounded-md bg-zinc-800" />
                    </div>
                    <div className="h-24 sm:h-32 rounded-lg bg-[radial-gradient(circle_at_20%_20%,rgba(74,222,128,0.45),transparent_55%),radial-gradient(circle_at_80%_70%,rgba(250,204,21,0.5),transparent_55%)]" />
                    <div className="mt-2 sm:mt-3 flex justify-between text-[8px] sm:text-[10px] text-zinc-400">
                      <span>Sites</span>
                      <span>Workers</span>
                      <span>Alerts</span>
                    </div>
                  ...
                  {/* center alerts list */}
                  <div className="col-span-4 rounded-xl bg-zinc-900/70 p-2 sm:p-3">
                    <div className="mb-2 flex items-center justify-between">
                      <div className="h-2.5 sm:h-3 w-14 sm:w-16 rounded-md bg-zinc-700" />
                      <div className="h-2.5 sm:h-3 w-6 sm:w-8 rounded-md bg-zinc-800" />
                    </div>
                    <div className="space-y-1 sm:space-y-1.5">
                      {[1, 2, 3, 4].map((i) => (
                        <div
                          key={i}
                          className="flex items-center justify-between rounded-md bg-zinc-950/80 px-1.5 sm:px-2 py-1 sm:py-1.5"
                        >
                          <div className="flex items-center gap-1.5 sm:gap-2">
                            <span className="h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-red-400" />
                            <span className="h-2.5 sm:h-3 w-14 sm:w-20 rounded bg-zinc-800" />
                          </div>
                          <span className="h-2.5 sm:h-3 w-8 sm:w-10 rounded bg-zinc-900" />
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {/* right mini chart */}
                  <div className="col-span-3 rounded-xl bg-zinc-900/80 p-2 sm:p-3">
                    <div className="mb-2 flex items-center justify-between">
                      <div className="h-2.5 sm:h-3 w-12 sm:w-14 rounded-md bg-zinc-700" />
                      <div className="h-2.5 sm:h-3 w-4 sm:w-5 rounded-md bg-zinc-800" />
                    </div>
                    <div className="h-20 sm:h-24 rounded-lg bg-[linear-gradient(to_top,rgba(39,39,42,0.9),transparent),repeating-linear-gradient(to_right,rgba(63,63,70,0.6)_0,rgba(63,63,70,0.6)_1px,transparent_1px,transparent_14px)] relative overflow-hidden">
                      <div className="absolute inset-x-1.5 sm:inset-x-2 bottom-1.5 sm:bottom-2 flex items-end gap-0.5 sm:gap-1">
                        {[20, 40, 60, 45, 80, 50].map((h, i) => (
                          <div
                            key={i}
                            className="flex-1 rounded-t-full bg-gradient-to-t from-yellow-400 via-yellow-300 to-emerald-400"
                ...
                <div className="mt-3 sm:mt-4 flex items-center justify-between text-[9px] sm:text-[10px] text-zinc-400">
                  <span>Live safety feed</span>
                  <span>Updated few seconds ago</span>
                </div>
              </div>
            ...
            <motion.div {...fadeUp}>
              ...
              <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 text-sm text-slate-100/90">
                {[
                  'Live map of workers and sites with status colours.',
                  'Alert feed with severity, type and time since trigger.',
                  'Acknowledgement and escalation flows for supervisors.',
                  'Incident timelines to support audits and investigations.',
                ].map((t) => (
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <motion.div {...fadeUp} className="text-center">
            ...
            <h2 className="mt-4 sm:mt-5 text-2xl sm:text-3xl md:text-4xl font-semibold text-white">
              A full safety lab inside every helmet.
            </h2>
            <p className="mx-auto mt-3 max-w-2xl text-sm md:text-base text-slate-300/85">
              Choose the sensors you need today and expand later as your safety program grows.
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                key={item.title}
                whileHover={{ y: -4 }}
                className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/3 via-black/40 to-black/80 p-4 sm:p-5 shadow-[0_26px_90px_rgba(0,0,0,0.9)]"
              >
                <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-yellow-400/10 px-2.5 sm:px-3 py-1 text-[10px] sm:text-[11px] font-medium uppercase tracking-[0.16em] text-yellow-300">
                  <span className="h-1.5 w-1.5 rounded-full bg-yellow-400" />
                  <span>SENSOR</span>
                </div>
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <motion.div {...fadeUp}>
            ...
            <h2 className="mt-4 sm:mt-5 text-2xl sm:text-3xl md:text-4xl font-semibold text-white leading-tight max-w-3xl">
              Built for both the worker and the control room.
            </h2>
          </motion.div>
          ...
          <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-10">
            {/* Worker side */}
            <motion.div {...fadeIn}>
              <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#18181b] via-[#020617] to-black p-4 sm:p-5 shadow-[0_28px_90px_rgba(0,0,0,0.95)]">
                <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-300">
                  On-helmet experience
                </h3>
                <p className="mt-3 text-sm text-slate-300/85">
                ...
                <div className="mt-4 sm:mt-5 space-y-2 sm:space-y-3 text-sm text-slate-100/90">
                  {[
                    'Vibration and audio alerts for gas, fall or zone breaches.',
                    'One-touch panic button from the helmet itself.',
                    'Simple light indicators for connectivity and status.',
                  ].map((t) => (
                ...
                {/* Helmet illustration */}
                <div className="mt-5 sm:mt-6 flex items-end justify-center">
                  <div className="relative">
                    <div className="pointer-events-none absolute inset-0 translate-y-4 rounded-full bg-[radial-gradient(circle_at_50%_10%,rgba(250,204,21,0.6),transparent_65%)] blur-2xl opacity-70" />
                    <Image
                      src={HelmetImage}
                      alt="Smart industrial safety helmet"
                      className="relative z-10 h-24 sm:h-28 md:h-32 w-auto drop-shadow-[0_0_32px_rgba(250,204,21,0.55)]"
                      quality={100}
                    />
                  </div>
                </div>
            ...
            {/* Control room side */}
            <motion.div {...fadeIn}>
              <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#0b0b0c] via-[#020617] to-black p-4 sm:p-5 shadow-[0_28px_90px_rgba(0,0,0,0.95)]">
                <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-300">
                  Control room experience
                </h3>
                <p className="mt-3 text-sm text-slate-300/85">
                ...
                <div className="mt-4 sm:mt-5 space-y-2 sm:space-y-3 text-sm text-slate-100/90">
                  {[
                    'Live roster of helmets and workers online, by site and shift.',
                    "One-click drill-down into any worker's recent events.",
                    'Preconfigured views for HSE, operations and management.',
                  ].map((t) => (
                    <div key={t} className="flex gap-2">
                      <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-yellow-400" />
                      <span>{t}</span>
                ...
                {/* stacked mini UI cards */}
                <div className="mt-5 sm:mt-6 grid grid-cols-2 gap-2 sm:gap-3 text-[11px] text-zinc-300">
                  <div className="rounded-lg bg-zinc-900/80 p-2 sm:p-3">
                    <div className="mb-2 h-2.5 sm:h-3 w-14 sm:w-16 rounded-md bg-zinc-700" />
                    <div className="space-y-1 sm:space-y-1.5">
                      <div className="h-2.5 sm:h-3 w-full rounded bg-zinc-800" />
                      <div className="h-2.5 sm:h-3 w-3/4 rounded bg-zinc-800/90" />
                      <div className="h-2.5 sm:h-3 w-2/3 rounded bg-zinc-800/80" />
                    </div>
                  </div>
                  <div className="rounded-lg bg-zinc-900/80 p-2 sm:p-3">
                    <div className="mb-2 h-2.5 sm:h-3 w-14 sm:w-16 rounded-md bg-zinc-700" />
                    <div className="h-16 sm:h-20 rounded bg-[radial-gradient(circle_at_20%_20%,rgba(34,197,94,0.45),transparent_55%),radial-gradient(circle_at_80%_80%,rgba(250,204,21,0.55),transparent_55%)]" />
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <div className="grid items-center gap-10 sm:gap-12 md:grid-cols-2">
            ...
            <motion.div {...fadeIn} className="flex justify-center">
              <div className="relative w-full max-w-xl rounded-2xl border border-sky-400/30 bg-gradient-to-b from-[#020617] via-[#020617] to-black p-4 sm:p-5 shadow-[0_32px_110px_rgba(0,0,0,1)]">
                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                  <div className="h-3.5 sm:h-4 w-24 sm:w-28 rounded-md bg-sky-400/40" />
                  <div className="h-3.5 sm:h-4 w-10 sm:w-12 rounded-md bg-zinc-800" />
                </div>

                <div className="grid grid-cols-4 gap-1.5 sm:gap-3 text-[11px] text-slate-200">
                  <div className="col-span-1 rounded-lg border border-yellow-400/60 bg-black/80 p-2 sm:p-3">
                    <div className="mb-1 text-[8px] sm:text-[10px] font-semibold uppercase tracking-[0.15em] text-yellow-300">
                      HELMETS
                    </div>
                    <div className="h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                    <div className="mt-1.5 sm:mt-2 h-2.5 sm:h-3 w-3/4 rounded bg-zinc-800" />
                  </div>
                  <div className="col-span-1 rounded-lg border border-sky-400/70 bg-sky-500/10 p-2 sm:p-3">
                    <div className="mb-1 text-[8px] sm:text-[10px] font-semibold uppercase tracking-[0.15em] text-sky-300">
                      AWS IOT CORE
                    </div>
                    <div className="h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                    <div className="mt-1.5 sm:mt-2 h-2.5 sm:h-3 w-full rounded bg-zinc-800" />
                  </div>
                  <div className="col-span-1 rounded-lg border border-emerald-400/70 bg-emerald-500/10 p-2 sm:p-3">
                    <div className="mb-1 text-[8px] sm:text-[10px] font-semibold uppercase tracking-[0.15em] text-emerald-300">
                      DYNAMODB
                    </div>
                    <div className="h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                    <div className="mt-1.5 sm:mt-2 h-2.5 sm:h-3 w-full rounded bg-zinc-800" />
                  </div>
                  <div className="col-span-1 rounded-lg border border-white/30 bg-white/5 p-2 sm:p-3">
                    <div className="mb-1 text-[8px] sm:text-[10px] font-semibold uppercase tracking-[0.15em] text-slate-200">
                      DASHBOARDS
                    </div>
                    <div className="h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                    <div className="mt-1.5 sm:mt-2 h-2.5 sm:h-3 w-3/4 rounded bg-zinc-800" />
                ...
                <div className="mt-4 sm:mt-5 space-y-1 text-[9px] sm:text-[10px] text-slate-400">
                  <div className="flex items-center gap-2">
                    <span className="h-px flex-1 bg-gradient-to-r from-yellow-400 via-sky-400 to-emerald-400" />
                    <span className="whitespace-nowrap">Helmet ➜ IoT Core ➜ DynamoDB ➜ Dashboards</span>
                  </div>
                  <div>Multi-tenant, role-based access and SSO-ready on a secure AWS backbone.</div>
                </div>
              </div>
            ...
            {/* RIGHT: Text */}
            <motion.div {...fadeUp}>
              <p className="inline-flex items-center rounded-full border border-sky-400/40 bg-sky-400/5 px-3 sm:px-4 py-1 text-[10px] sm:text-xs font-medium uppercase tracking-[0.18em] text-sky-300">
                Cloud architecture
              </p>
              ...
              <div className="mt-4 sm:mt-6 space-y-2 sm:space-y-3 text-sm text-slate-100/90">
                {[
                  'Secure device ingest and bidirectional messaging via AWS IoT Core.',
                  'Durable, low-latency storage of sensor readings and worker state in Amazon DynamoDB.',
                  'Real-time dashboards powered by APIs and DynamoDB streams.',
                  'Role-based access control, SSO integration and audit-friendly logging.',
                ].map((t) => (
                  <div key={t} className="flex gap-2">
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          ...
          <motion.div
            {...fadeIn}
            className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6"
          >
            {[
              {
                title: 'Construction & infrastructure',
              ...
              <motion.div
                key={item.title}
                whileHover={{ y: -4 }}
                className="rounded-2xl border border-white/8 bg-gradient-to-b from-white/3 via-black/40 to-black/80 p-4 sm:p-5 text-left shadow-[0_24px_80px_rgba(0,0,0,0.9)]"
              >
                <h3 className="text-sm font-semibold text-white">{item.title}</h3>
                <p className="mt-2 text-sm text-slate-300/85">{item.body}</p>
              </motion.div>
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <motion.div
            {...fadeIn}
            className="grid items-center gap-8 sm:gap-10 rounded-3xl border border-white/10 bg-gradient-to-r from-[#0b0b0c] via-[#020617] to-black px-5 sm:px-6 py-8 sm:py-10 md:grid-cols-2 md:px-10"
          >
            {/* Text */}
            <div>
              <p className="inline-flex items-center rounded-full border border-yellow-400/40 bg-yellow-400/5 px-3 sm:px-4 py-1 text-[10px] sm:text-xs font-medium uppercase tracking-[0.18em] text-yellow-300">
              ...
              <ul className="mt-4 sm:mt-5 space-y-2 text-sm text-slate-100/90">
                {[
                  'Tailored demos using your own use cases and environments.',
                  'Clear rollout plan with hardware, software and integrations.',
                ].map((t) => (
              ...
              <div className="mt-6 sm:mt-7 flex flex-wrap items-center gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-full bg-yellow-400 px-6 sm:px-7 py-2.5 sm:py-3 text-sm font-medium text-black shadow-[0_0_40px_rgba(250,204,21,0.8)] transition-transform duration-200 hover:-translate-y-0.5 active:scale-95"
                >
                  Connect now
                  <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-black/10 text-xs">
                    ↗
            ...
            <div className="relative flex justify-center md:justify-end">
              {/* Card */}
              <div className="relative w-full max-w-sm sm:max-w-md rounded-2xl border border-white/10 bg-gradient-to-b from-[#18181b] via-[#020617] to-black p-3 sm:p-4 shadow-[0_32px_110px_rgba(0,0,0,1)]">
                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                  <div className="flex gap-1.5">
                  ...
                  <div className="h-3.5 sm:h-4 w-20 sm:w-24 rounded-full bg-zinc-800/80" />
                </div>

                <div className="grid grid-cols-5 gap-2 sm:gap-3">
                  <div className="col-span-2 space-y-1.5 sm:space-y-2">
                    <div className="h-3.5 sm:h-4 w-full rounded-md bg-zinc-800/90" />
                    <div className="space-y-1 sm:space-y-1.5">
                      <div className="h-2.5 sm:h-3 w-full rounded bg-zinc-900" />
                      <div className="h-2.5 sm:h-3 w-4/5 rounded bg-zinc-800" />
                      <div className="h-2.5 sm:h-3 w-3/5 rounded bg-zinc-800/80" />
                      <div className="h-2.5 sm:h-3 w-2/3 rounded bg-zinc-800/60" />
                    </div>
                  </div>

                  <div className="col-span-3 space-y-1.5 sm:space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="h-3.5 sm:h-4 w-16 sm:w-24 rounded-md bg-zinc-800/90" />
                      <div className="h-3.5 sm:h-4 w-8 sm:w-10 rounded-md bg-zinc-900" />
                    </div>
                    <div className="h-16 sm:h-24 rounded-xl bg-[radial-gradient(circle_at_20%_20%,rgba(250,204,21,0.25),transparent_55%),radial-gradient(circle_at_80%_70%,rgba(34,197,94,0.25),transparent_55%)]" />
                    <div className="flex gap-1.5 sm:gap-2">
                      <div className="h-5 sm:h-6 flex-1 rounded-md bg-zinc-900/80" />
                      <div className="h-5 sm:h-6 flex-1 rounded-md bg-zinc-900/60" />
                    </div>
                  </div>
                </div>

                <div className="mt-3 sm:mt-4 flex items-center justify-between">
                  <div className="h-2.5 sm:h-3 w-14 sm:w-16 rounded-md bg-zinc-800/80" />
                  <div className="flex gap-1.5 sm:gap-2">
                    <div className="h-6 sm:h-7 w-14 sm:w-16 rounded-full bg-yellow-400/80" />
                    <div className="h-6 sm:h-7 w-14 sm:w-16 rounded-full bg-zinc-800/80" />
                  </div>
                </div>
