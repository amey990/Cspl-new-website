...
//p2//
// src/app/components/PartnersCubesField.tsx
// 'use client';
...
//           <div className="flex h-full w-full items-center justify-center">
//             <Handshake
//               className="text-white/95 drop-shadow-[0_0_18px_rgba(255,255,255,0.08)]"
  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#050506]">
      ...
      <div className="relative z-10 flex flex-col items-center px-4 pb-10 pt-5 text-center sm:px-6 sm:pb-14 sm:pt-6">
        ...
        <div className="mt-3 flex flex-wrap justify-center gap-2 text-[10px] sm:text-[11px] text-slate-200">
          {[
            { label: 'Cloud & Infra', color: 'bg-sky-400' },
            { label: 'Broadcast & Media', color: 'bg-fuchsia-400' },
            { label: 'Network OEMs', color: 'bg-emerald-400' },
            { label: 'System Integrators', color: 'bg-amber-300' },
            { label: 'Analytics & AI', color: 'bg-cyan-300' },
          ].map(({ label, color }) => (
