...
import OpsAdvisorImage from '../../../assets/products/ops-adv.png';
import OpsAdvisorImage2 from '../../../assets/products/ops1.png';
const easeOutExpo = cubicBezier(0.22, 1, 0.36, 1);
const ACCENT = '#FF5906';
    ...
    <main className="relative w-full overflow-hidden bg-[#010101]">
      ...
      <div className="relative z-10 pt-14 sm:pt-16 md:pt-20 pb-16 sm:pb-20 md:pb-24">
        ...
        <section className="mt-10 sm:mt-14 md:mt-16 mx-auto flex max-w-6xl flex-col gap-10 sm:gap-12 px-5 sm:px-8 md:flex-row md:px-10 lg:px-16">
          ...
          <motion.div
            {...fadeUp}
            className="flex-1 space-y-4 sm:space-y-6 md:max-w-md"
          >
            {/* breadcrumb chip */}
            <div className="mb-1 flex items-center gap-2 sm:gap-3 text-sm text-slate-200">
              <span
                className="h-2.5 w-4 sm:w-5 rounded-full shadow-[0_0_12px_rgba(255,89,6,0.9)]"
                style={{ backgroundColor: ACCENT }}
              />
              <span className="text-[14px] sm:text-[15px] text-slate-100">Operations Advisor</span>
              <span className="text-lg leading-none text-slate-500">›</span>
            </div>
            ...
            {/* bullets */}
            <div className="space-y-2 sm:space-y-3 text-sm text-slate-100/90">
              {[
                'Agentic workflows that triage, route and recommend actions automatically.',
                'Live health scores across sites, assets and customer-facing services.',
          ...
          >
            ...
            <div
              className="relative w-full max-w-[480px] sm:max-w-[520px] md:max-w-[540px] rounded-[16px] sm:rounded-[20px] border border-white/10 bg-[#101012] shadow-[0_40px_120px_rgba(0,0,0,0.95)]"
              style={{
  ...
  >
    ...
    />
        ...
        <section className="mt-20 sm:mt-24 md:mt-28 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <div className="grid items-center gap-10 sm:gap-12 md:grid-cols-2">
            ...
            <motion.div {...fadeUp}>
              ...
              <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-sm text-slate-100/90">
                {[
                  {
                    title: 'Signal intake',
                    body: 'Connect monitoring tools, ticketing systems and logs to build a single stream of operational events.',
                  },
                  {
                    title: 'Situation engine',
                    body: 'Cluster related alerts and tickets into one \u201cstory\u201d so teams work the incident, not individual pings.',
                  },
                  {
                    title: 'Agentic playbooks',
                    body: 'AI-guided workflows propose actions, ask for confirmations and adapt in real time as signals change.',
                  },
                  {
                    title: 'Learning loop',
                    body: 'Outcomes and operator feedback tune future recommendations and playbooks automatically.',
                  },
                ].map((item) => (
            ...
            <motion.div {...fadeIn} className="flex justify-center">
              <div className="relative w-full max-w-xl rounded-2xl border border-white/10 bg-gradient-to-b from-[#1b130c] via-[#050506] to-black p-4 sm:p-6 shadow-[0_36px_120px_rgba(0,0,0,0.95)]">
                {/* Row 1: sources */}
                <div className="grid grid-cols-3 gap-2 sm:gap-3 text-[11px] text-slate-200">
                  {['Monitoring', 'Tickets', 'Logs'].map((src) => (
                    <div key={src} className="rounded-xl border border-white/10 bg-black/75 p-2 sm:p-3">
                      <div className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-300">
                        {src}
                      </div>
                      <div className="mt-2 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                ...
                {/* arrow */}
                <div className="mt-3 sm:mt-4 flex items-center gap-2 sm:gap-3 text-[11px] text-slate-300">
                  <div className="h-px flex-1 bg-gradient-to-r from-white via-[rgba(255,89,6,0.9)] to-transparent" />
                ...
                {/* Ops advisor core */}
                <div className="mt-3 rounded-2xl border border-[rgba(255,89,6,0.8)] bg-[radial-gradient(circle_at_5%_0%,rgba(255,137,92,0.33),transparent_55%),rgba(15,8,3,0.95)] px-3 sm:px-4 py-3 sm:py-4 shadow-[0_0_32px_rgba(255,89,6,0.6)]">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.16em] text-orange-100">
                        OPS ADVISOR CORE
                      </div>
                      <div className="mt-1 h-2.5 sm:h-3 w-24 sm:w-32 rounded bg-zinc-700/80" />
                    </div>
                    <div className="flex gap-1.5">
                      <span className="h-2 w-2 rounded-full bg-emerald-400" />
                      <span className="h-2 w-2 rounded-full bg-amber-300" />
                ...
                <div className="mt-3 grid grid-cols-3 gap-1.5 sm:gap-2 text-[11px] text-slate-200">
                  {['Ops console', 'Chat & war rooms', 'Ticket updates'].map((out) => (
                    <div key={out} className="rounded-lg border border-white/15 bg-black/75 p-2 sm:p-3">
                      <div className="mb-1 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                      <div className="h-8 sm:h-10 rounded bg-zinc-900/90" />
                      <div className="mt-1 text-[8px] sm:text-[10px] text-slate-400">{out}</div>
                    </div>
                  ))}
                </div>

                <div className="mt-3 sm:mt-4 text-[10px] sm:text-[11px] text-slate-400">
                  A full loop from raw signals to guided actions that operators can accept,
                  adjust or automate.
                </div>
              </div>
          ...
          <div className="grid items-center gap-10 sm:gap-12 md:grid-cols-2">
              ...
              <div className="relative w-full max-w-xl rounded-2xl border border-white/10 bg-gradient-to-b from-[#171717] via-[#050505] to-black p-3 sm:p-4 md:p-5 shadow-[0_40px_130px_rgba(0,0,0,1)]">
                ...
                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                  <div className="flex gap-1.5">
                    ...
                    <span className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-amber-400/60" />
                ...
                <div className="grid grid-cols-12 gap-2 sm:gap-3">
                  {/* left: health map */}
                  <div className="col-span-5 rounded-xl bg-zinc-900/85 p-2 sm:p-3">
                    <div className="mb-2 flex items-center justify-between">
                      <div className="h-2.5 sm:h-3 w-16 sm:w-20 rounded bg-zinc-700" />
                      <div className="h-2.5 sm:h-3 w-8 sm:w-10 rounded bg-zinc-800" />
                    </div>
                    <div className="h-24 sm:h-32 rounded-lg bg-[radial-gradient(circle_at_20%_15%,rgba(34,197,94,0.6),transparent_55%),radial-gradient(circle_at_70%_60%,rgba(250,204,21,0.6),transparent_55%),radial-gradient(circle_at_40%_95%,rgba(248,113,113,0.7),transparent_55%)]" />
                  ...
                  {/* center: situations list */}
                  <div className="col-span-4 rounded-xl bg-zinc-900/85 p-2 sm:p-3">
                    <div className="mb-2 flex items-center justify-between">
                      <div className="h-2.5 sm:h-3 w-14 sm:w-16 rounded bg-zinc-700" />
                      <div className="h-2.5 sm:h-3 w-6 sm:w-8 rounded bg-zinc-800" />
                    </div>
                    <div className="space-y-1 sm:space-y-1.5">
                      {[1, 2, 3, 4].map((i) => (
                        <div
                          key={i}
                          className="flex items-center justify-between rounded-md bg-zinc-950/90 px-1.5 sm:px-2 py-1 sm:py-1.5"
                        >
                          <div className="flex items-center gap-1.5 sm:gap-2">
                            <span className="h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-amber-400" />
                            <span className="h-2.5 sm:h-3 w-16 sm:w-24 rounded bg-zinc-800" />
                          </div>
                  ...
                  {/* right: actions meter */}
                  <div className="col-span-3 rounded-xl bg-zinc-900/85 p-2 sm:p-3">
                    <div className="mb-2 flex items-center justify-between">
                      <div className="h-2.5 sm:h-3 w-12 rounded bg-zinc-700" />
                      <div className="h-2.5 sm:h-3 w-5 sm:w-6 rounded bg-zinc-800" />
                    </div>
                    <div className="h-20 sm:h-24 rounded-lg bg-[linear-gradient(to_top,rgba(24,24,27,0.95),transparent),repeating-linear-gradient(to_right,rgba(63,63,70,0.7)_0,rgba(63,63,70,0.7)_1px,transparent_1px,transparent_12px)] relative overflow-hidden">
            ...
            <motion.div {...fadeUp}>
              ...
              <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 text-sm text-slate-100/90">
                {[
                  'Health scores for every site, line of business and key service.',
                  'Situation list that shows impact, trend and who is currently working it.',
                  'Recommended first steps that level 1 teams can execute safely.',
                  'Historical view to spot repeating issues and long-running risks.',
                ].map((text) => (
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <motion.div
            {...fadeIn}
            className="grid items-center gap-8 sm:gap-10 rounded-3xl border border-white/10 bg-gradient-to-r from-[#1b130c] via-[#020617] to-black px-5 sm:px-6 py-8 sm:py-10 md:grid-cols-2 md:px-10"
          >
            {/* Text */}
            <div>
              <p
              ...
              <ul className="mt-4 sm:mt-5 space-y-2 text-sm text-slate-100/90">
                {[
                  'Tailored demos using your own alert streams and tickets.',
                  'Rollout plan with integrations, playbook design and training.',
                ].map((text) => (
              ...
              <div className="mt-6 sm:mt-7 flex flex-wrap items-center gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-full px-6 sm:px-7 py-2.5 sm:py-3 text-sm font-medium text-black shadow-[0_0_40px_rgba(255,89,6,0.8)] transition-transform duration-200 hover:-translate-y-0.5 active:scale-95"
                  style={{ backgroundColor: ACCENT }}
                >
                  Connect now
                  <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-black/10 text-xs">
              ...
              <div className="relative w-full max-w-sm sm:max-w-md rounded-2xl border border-white/10 bg-gradient-to-b from-[#18181b] via-[#020617] to-black p-3 sm:p-4 shadow-[0_32px_110px_rgba(0,0,0,1)]">
                ...
                <div className="grid grid-cols-5 gap-2 sm:gap-3">
                  ...
                  <div className="col-span-3 space-y-1.5 sm:space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="h-3.5 sm:h-4 w-20 sm:w-24 rounded-md bg-zinc-800/90" />
                      <div className="h-3.5 sm:h-4 w-8 sm:w-10 rounded-md bg-zinc-900" />
                    </div>
                    <div className="h-20 sm:h-24 rounded-xl bg-[radial-gradient(circle_at_20%_20%,rgba(255,137,92,0.3),transparent_55%),radial-gradient(circle_at_80%_70%,rgba(34,197,94,0.3),transparent_55%)]" />
