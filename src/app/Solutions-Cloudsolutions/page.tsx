...
import CloudSolutionsHero from '../../../assets/Cloud.png';
...
> = {
  // Backgrounds are neutral now. Keep colored borders/text/dots only.
  emerald: {
    dot: 'bg-emerald-400',
    pill: 'border-emerald-400/40 bg-black/30 text-emerald-100',
  },
  sky: {
    dot: 'bg-sky-400',
    pill: 'border-sky-400/40 bg-black/30 text-sky-100',
  },
  fuchsia: {
    dot: 'bg-fuchsia-400',
    pill: 'border-fuchsia-400/40 bg-black/30 text-fuchsia-100',
  },
  amber: {
    dot: 'bg-amber-400',
    pill: 'border-amber-400/40 bg-black/30 text-amber-100',
  },
};
  ...
  <span className="block text-amber-300">
    not the other way round.
            ...
            <motion.div {...fadeIn} className="relative flex items-center justify-center">
              {/* neutral blobs only */}
              <div className="pointer-events-none absolute -left-8 top-0 h-40 w-40 rounded-full bg-white/8 blur-3xl" />
              <div className="pointer-events-none absolute -right-8 bottom-0 h-48 w-48 rounded-full bg-white/6 blur-3xl" />

              <div className="relative w-full max-w-md rounded-3xl border border-white/10 bg-gradient-to-b from-zinc-950 via-black to-black p-5 shadow-[0_26px_100px_rgba(0,0,0,1)]">
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-zinc-950/80">
                  ...
                  {/* Mobile fallback: abstract diagram (neutral bg) */}
                  <div className="flex aspect-[16/10] flex-col items-center justify-center gap-3 px-4 text-center text-xs text-slate-300 md:hidden">
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-3xl border border-white/15 bg-black/60">
                      <div className="absolute inset-0 rounded-3xl bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.18),transparent_60%)]" />
                      <CloudLightning className="relative h-7 w-7 text-white/90" />
                    </div>
        ...
        <section className="mx-auto mt-20 max-w-6xl px-6 md:px-10 lg:px-16">
          ...
          <motion.div {...fadeUp} className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/60 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.9)]">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.18em] text-slate-200">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/60 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.9)]">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.18em] text-slate-200">
                <Video className="h-3.5 w-3.5 text-fuchsia-200" />
                Media pipelines
              </div>
              <p className="text-sm font-medium text-white">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/60 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.9)]">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.18em] text-slate-200">
                <RadioTower className="h-3.5 w-3.5 text-amber-200" />
                IoT &amp; telemetry
              </div>
        ...
        <section className="mx-auto mt-20 max-w-6xl px-6 md:px-10 lg:px-16">
          <motion.div
            {...fadeUp}
            className="rounded-[32px] border border-white/10 bg-gradient-to-b from-zinc-950/90 via-black to-black px-6 py-8 shadow-[0_28px_120px_rgba(0,0,0,1)] md:px-10 md:py-10"
          >
            <div className="grid gap-10 md:grid-cols-[1.35fr,1fr] md:items-center">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-black/70 px-6 py-8">
                {/* Center cloud (neutral background/glow) */}
                <div className="relative mx-auto flex h-20 w-20 items-center justify-center rounded-3xl border border-white/15 bg-black/70 shadow-[0_18px_80px_rgba(0,0,0,1)]">
                  <div className="absolute inset-0 rounded-3xl bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.20),transparent_60%)]" />
                  <CloudLightning className="relative h-8 w-8 text-white/90" />
                </div>

                {/* Rings (neutral) */}
                <div className="pointer-events-none absolute left-1/2 top-1/2 h-40 w-40 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/18" />
                ...
                <div className="pointer-events-none absolute left-1/2 top-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/6" />

                {/* Nodes (neutral backgrounds; colored icons are fine) */}
                <div className="absolute left-4 top-6 space-y-3 text-xs text-slate-200">
                  <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-black/55 px-3 py-2">
        ...
        <section className="mx-auto mt-20 max-w-6xl px-6 md:px-10 lg:px-16">
          ...
          >
            <li className="relative rounded-2xl border border-white/10 bg-black/70 p-4">
              <span className="mb-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-white/5 text-xs font-semibold text-sky-200">
                01
              </span>
              <p className="text-sm font-medium text-white">
