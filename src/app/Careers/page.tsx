        ...
        <section className="mx-auto flex max-w-6xl flex-col gap-10 px-4 sm:px-6 md:flex-row md:items-center md:gap-12 md:px-10 lg:px-16">
          ...
          <motion.div {...fadeUp} className="flex-1 space-y-5 sm:space-y-6">
            ...
            <p className="max-w-xl text-sm leading-relaxed text-slate-300/85 md:text-base">
              We create scalable, AI-driven technologies that power critical operations
              for global enterprises. Join a team of experts solving complex challenges,
              delivering real-world impact, and advancing their careers.
            </p>
            ...
            <div className="flex flex-wrap gap-4 text-xs text-slate-400 sm:gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>High-impact technical roles</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          >
            <div className="relative w-full max-w-sm md:max-w-md">
              ...
              <div className="mt-3 rounded-2xl border border-emerald-400/30 bg-emerald-400/5 px-3 py-2.5 text-xs text-emerald-100/90 sm:mt-4 sm:px-4 sm:py-3">
                <span className="font-semibold uppercase tracking-[0.16em]">Why now?</span>
                <p className="mt-1 text-[10px] text-slate-200/90 sm:text-[11px]">
                  As we expand our global footprint, you'll have the chance to architect
                  enterprise-grade systems at scale and accelerate your professional growth.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div {...fadeUp} className="flex flex-col gap-8 sm:gap-10">
            ...
            <div className="max-w-3xl">
              ...
              <ul className="mt-4 space-y-2.5 text-sm text-slate-100/90 sm:mt-6 sm:space-y-3">
                {[
                  'Hybrid-first: a few anchor days in office for deep collaboration, remote-friendly for focused work.',
                  'Makers\' schedule: long, protected blocks for building instead of back-to-back meetings.',
                  'Real ownership over product areas, with visibility to customers and leadership.',
                ].map((item) => (
              ...
              <motion.div {...fadeIn} className="w-full md:flex-1 md:flex md:justify-end">
                <div className="w-full rounded-2xl border border-white/10 bg-gradient-to-b from-[#18181b] via-[#020617] to-black p-4 shadow-[0_28px_100px_rgba(0,0,0,1)] md:max-w-sm">
                    ...
                    {[
                      {
                        dot: 'bg-emerald-400',
                        day: 'Monday',
                        desc: 'Product review & planning. Align on goals, unblock work.',
                      },
                      {
                        dot: 'bg-sky-400',
                        day: 'TueThu',
                        desc: 'Deep build time. Pairing, async updates, customer calls when needed.',
                      },
                      {
                        dot: 'bg-fuchsia-400',
                        day: 'Friday',
                        desc: 'Demo hour, tech talks and retros. Close the loop and celebrate wins.',
                      },
                    ].map(({ dot, day, desc }) => (
                  ...
                  <div className="mt-3 text-[10px] text-slate-500 sm:mt-4 sm:text-[11px]">
                    Minimal bureaucracy. Maximum context.
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        >
          ...
          <motion.div {...fadeIn} className="mt-6 space-y-3 sm:mt-8 sm:space-y-4">
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="mt-2.5 flex flex-wrap gap-2 text-[10px] text-slate-300 sm:mt-3 sm:text-[11px]">
                    ...
                    <span className="rounded-full bg-white/5 px-2.5 py-1">{role.type}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-shrink-0 items-center">
                  <Link
                    href="/contact"
                    className="inline-flex items-center gap-2 rounded-full bg-emerald-400 px-4 py-2 text-xs font-medium text-black shadow-[0_0_30px_rgba(52,211,153,0.6)] transition-transform duration-200 hover:-translate-y-0.5 sm:px-5"
                  >
                    Apply / Refer
            ...
            <div className="mt-4 rounded-2xl border border-dashed border-white/18 bg-black/40 px-4 py-3.5 text-xs text-slate-300/85 sm:mt-6 sm:px-5 sm:py-4 sm:text-sm">
              <span className="font-semibold text-slate-100">No perfect role yet?</span>{' '}
        ...
        <section className="mx-auto mt-20 max-w-6xl px-4 sm:mt-24 sm:px-6 md:mt-28 md:px-10 lg:px-16">
          ...
          >
            ...
            <div className="w-full">
              <div className="w-full rounded-2xl border border-white/10 bg-gradient-to-b from-[#18181b] via-[#020617] to-black p-4 shadow-[0_32px_110px_rgba(0,0,0,1)] sm:p-5">
                {/* window chrome */}
                ...
                <div className="space-y-3 text-xs text-slate-200 sm:space-y-4">
                  {[
                    ...
                    { label: 'Email ID', type: 'email', placeholder: 'Enter your email' },
                  ...
                  <div>
                    ...
                    <select
                      className="w-full rounded-lg border border-white/10 bg-zinc-900/70 px-3 py-2 text-xs text-slate-100 focus:border-emerald-400 focus:outline-none sm:text-[13px]"
                      defaultValue=""
                    >
                  ...
                  <p className="pt-0.5 text-[9px] text-slate-500 sm:pt-1 sm:text-[10px]">
                    Use the{' '}
