...
//   return (
//     <footer className="relative mt-24 w-full border-t border-white/10 bg-[#010000]">
//       {/* subtle radial glow */}
...
//       {/* ====== Bottom bar (no extra space after) ====== */}
//       <div className="relative mx-auto mt-10 max-w-screen-2xl px-4 md:px-6 lg:px-8">
//         <div className="border-t border-white/10 py-6 text-sm text-zinc-400">
...
//         </div>
//       </div>
//       {/* No extra padding/margin after this point */}
//     </footer>
//   );
// }
