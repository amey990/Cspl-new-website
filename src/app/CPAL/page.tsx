  ...
  return (
    <main className="relative w-full overflow-hidden bg-[#010101]">
      ...
      <div className="relative z-10 pt-14 sm:pt-16 md:pt-20 pb-16 sm:pb-20 md:pb-24">
        ...
        {/* 1. HERO SECTION                                                    */}
        {/* ------------------------------------------------------------------ */}
        <section className="mt-10 sm:mt-14 md:mt-16 mx-auto flex max-w-6xl flex-col-reverse gap-10 sm:gap-12 px-5 sm:px-8 md:flex-row md:px-10 lg:px-16">
          {/* LEFT: Lottie / AI core visual */}
          <motion.div
            initial={{ opacity: 0, x: -24, y: 10, scale: 0.95 }}
            whileInView={{ opacity: 1, x: 0, y: 0, scale: 1 }}
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 -z-10">
              <div
                className="absolute left-1/2 top-1/2 h-48 w-48 sm:h-64 sm:w-64 md:h-80 md:w-80 -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl"
                style={{
                  background: 'radial-gradient(circle, rgba(25,226,143,0.35) 0%, transparent 65%)',
                }}
              />
            </div>

            <div className="relative w-full max-w-[320px] sm:max-w-[420px] md:max-w-[540px]">
              <Lottie animationData={AiCoreAnimation} loop autoplay className="h-auto w-full" />
            </div>
          </motion.div>
          ...
          <motion.div {...fadeUp} className="flex-1 space-y-4 sm:space-y-6 md:max-w-md">
            {/* breadcrumb chip */}
            <div className="mb-1 sm:mb-2 flex items-center gap-2 sm:gap-3 text-sm text-slate-200">
              <span
                className="h-2.5 w-4 sm:w-5 rounded-full shadow-[0_0_12px_rgba(25,226,143,0.85)]"
                style={{ backgroundColor: ACCENT }}
              />
              <span className="text-[14px] sm:text-[15px] text-slate-100">C-pal Chatbot</span>
              <span className="text-lg leading-none text-slate-500">›</span>
            </div>

            {/* section label */}
            <p
              className="inline-flex items-center rounded-full border px-3 sm:px-4 py-1 text-[10px] sm:text-xs font-medium uppercase tracking-[0.18em]"
              style={{
                borderColor: `${ACCENT}66`,
                backgroundColor: `${ACCENT}14`,
                color: '#BBF7D0',
            ...
            {/* bullets */}
            <div className="mt-1 sm:mt-2 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 text-sm text-slate-100/90">
              {[
                'Natural language queries over tickets, tasks and documentation.',
                'Smart summaries for stand-ups, incident reviews and hand-offs.',
                'Works where your teams already are Slack, email and more.',
        ...
        <section className="mt-20 sm:mt-24 md:mt-28 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <div className="grid items-center gap-10 sm:gap-12 md:grid-cols-2">
            ...
            <motion.div {...fadeUp}>
              ...
              <h2 className="mt-4 sm:mt-5 max-w-xl text-2xl sm:text-3xl md:text-4xl font-semibold leading-tight text-white">
                Connects to your tools, understands your work, then answers in natural language.
              </h2>
            ...
            {/* RIGHT: Flow diagram card */}
            <motion.div {...fadeIn} className="flex justify-center">
              <div className="relative w-full max-w-xl rounded-2xl border border-white/12 bg-gradient-to-b from-[#031515] via-[#02070A] to-black p-4 sm:p-6 shadow-[0_36px_120px_rgba(0,0,0,0.95)]">
                {/* TOP ROW: tools */}
                <div className="grid grid-cols-3 gap-2 sm:gap-3 text-[11px] text-slate-200">
                  {['Tickets', 'Chat', 'Docs & Wikis'].map((label) => (
                    <div key={label} className="rounded-xl border border-white/10 bg-black/70 p-2 sm:p-3">
                      <div className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-300">
                        {label}
                      </div>
                      <div className="mt-1 sm:mt-1.5 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                      <div className="mt-1.5 sm:mt-2 flex gap-1">
                        <div className="h-1.5 sm:h-2 w-5 sm:w-6 rounded bg-zinc-800" />
                        <div className="h-1.5 sm:h-2 w-5 sm:w-6 rounded bg-zinc-800/80" />
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-3 sm:mt-4 flex items-center gap-2 sm:gap-3">
                  <div className="h-px flex-1 bg-gradient-to-r from-white via-[rgba(25,226,143,0.9)] to-transparent" />
                  <span className="text-[9px] sm:text-[10px] tracking-wide text-slate-300/90 whitespace-nowrap">
                    APIs · Webhooks · Connectors
                  </span>
                </div>

                {/* CPAL CORE */}
                <div className="mt-3 rounded-2xl border border-[rgba(25,226,143,0.85)] bg-[radial-gradient(circle_at_10%_0%,rgba(25,226,143,0.32),transparent_60%),rgba(6,24,22,0.95)] px-3 sm:px-4 py-3 sm:py-4 shadow-[0_0_32px_rgba(25,226,143,0.6)]">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.16em] text-[#CFFAFE]">
                        C-PAL AI CORE
                      </div>
                      <div className="mt-1 h-2.5 sm:h-3 w-24 sm:w-28 rounded bg-zinc-700/80" />
                    </div>
                    <div className="flex gap-1.5">
                      <span className="h-2 w-2 rounded-full bg-emerald-400" />
                      <span className="h-2 w-2 rounded-full bg-amber-300" />
                  ...
                  <div className="mt-2 sm:mt-3 grid grid-cols-3 gap-1.5 sm:gap-2 text-[10px] text-slate-100">
                    {['Search', 'Summarise', 'Suggest'].map((cap) => (
                      <div key={cap} className="rounded-lg bg-black/75 p-1.5 sm:p-2">
                        <div className="mb-1 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                        <div className="h-1.5 sm:h-2 w-3/4 rounded bg-zinc-800" />
                        <div className="mt-1 text-[8px] sm:text-[9px] text-slate-400">{cap}</div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                {/* OUTPUT CHANNELS */}
                <div className="mt-3 grid grid-cols-3 gap-1.5 sm:gap-2 text-[11px] text-slate-200">
                  <div className="rounded-lg border border-white/15 bg-black/70 p-2 sm:p-3">
                    <div className="mb-1 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                    <div className="h-7 sm:h-9 rounded bg-[radial-gradient(circle_at_20%_10%,rgba(25,226,143,0.55),transparent_60%)]" />
                    <div className="mt-1 text-[8px] sm:text-[10px] text-slate-400">Slack &amp; chat</div>
                  </div>
                  <div className="rounded-lg border border-white/15 bg-black/70 p-2 sm:p-3">
                    <div className="mb-1 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                    <div className="space-y-1">
                      <div className="h-1.5 sm:h-2 w-full rounded bg-zinc-800" />
                      <div className="h-1.5 sm:h-2 w-4/5 rounded bg-zinc-800" />
                      <div className="h-1.5 sm:h-2 w-3/5 rounded bg-zinc-800" />
                    </div>
                    <div className="mt-1 text-[8px] sm:text-[10px] text-slate-400">Email &amp; reports</div>
                  </div>
                  <div className="rounded-lg border border-white/15 bg-black/70 p-2 sm:p-3">
                    <div className="mb-1 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                    <div className="h-7 sm:h-9 rounded bg-zinc-900/90" />
                    <div className="mt-1 text-[8px] sm:text-[10px] text-slate-400">Portals &amp; apps</div>
                  </div>
                </div>
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <div className="grid items-center gap-10 sm:gap-12 md:grid-cols-2">
            {/* LEFT: dashboard / chat mock */}
            <motion.div {...fadeIn} className="flex justify-center">
              <div className="relative w-full max-w-xl rounded-2xl border border-white/10 bg-gradient-to-b from-[#07120f] via-[#020814] to-black p-3 sm:p-4 md:p-5 shadow-[0_40px_130px_rgba(0,0,0,1)]">
                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                  <div className="flex gap-1.5">
                    <span className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-rose-500/60" />
                ...
                <div className="grid grid-cols-12 gap-2 sm:gap-3">
                  {/* Chat area */}
                  <div className="col-span-8 rounded-xl bg-zinc-950/90 p-2 sm:p-3">
                    <div className="mb-2 flex items-center justify-between">
                      <div className="h-2.5 sm:h-3 w-16 sm:w-20 rounded bg-zinc-700" />
                      <div className="h-2.5 sm:h-3 w-10 sm:w-12 rounded bg-zinc-800" />
                    </div>

                    <div className="space-y-2">
                      <div className="flex justify-end">
                        <div className="max-w-[80%] rounded-2xl rounded-br-sm bg-zinc-800 px-2 sm:px-3 py-1.5 sm:py-2 text-[9px] sm:text-[10px] text-zinc-100">
                          What happened with incident INC-4321 overnight?
                        </div>
                      </div>
                      <div className="flex justify-start">
                        <div
                          className="max-w-[85%] rounded-2xl rounded-bl-sm px-2 sm:px-3 py-1.5 sm:py-2 text-[9px] sm:text-[10px] text-zinc-100"
                          style={{ backgroundColor: 'rgba(25,226,143,0.08)' }}
                        >
                          C-pal: 3 alerts correlated, linked to WAN link &quot;MUM-EDGE-02&quot;. Impact: 5 branches. Summary and recommended first steps below.
                        </div>
                      </div>
                      <div className="flex justify-start">
                        <div className="mt-1 h-12 sm:h-16 w-full rounded-xl bg-[linear-gradient(to_bottom,rgba(12,148,136,0.25),transparent),rgba(9,9,11,0.9)]" />
                      </div>
                    </div>

                    <div className="mt-2 sm:mt-3 flex items-center gap-2 rounded-full bg-zinc-900 px-2 sm:px-3 py-1 sm:py-1.5">
                  ...
                  <div className="col-span-4 space-y-2 sm:space-y-3">
                    <div className="rounded-xl bg-zinc-950/90 p-2 sm:p-3 text-[10px] text-zinc-200">
                      <div className="mb-1.5 sm:mb-2 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                      <div className="space-y-1 sm:space-y-1.5">
                        <div className="h-1.5 sm:h-2 w-full rounded bg-zinc-800" />
                        <div className="h-1.5 sm:h-2 w-4/5 rounded bg-zinc-800" />
                        <div className="h-1.5 sm:h-2 w-3/5 rounded bg-zinc-800/90" />
                      </div>
                    </div>
                    <div className="rounded-xl bg-zinc-950/90 p-2 sm:p-3 text-[10px] text-zinc-200">
                      <div className="mb-1.5 sm:mb-2 h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                      <div className="h-10 sm:h-14 rounded bg-[radial-gradient(circle_at_10%_10%,rgba(25,226,143,0.4),transparent_60%),radial-gradient(circle_at_90%_80%,rgba(59,130,246,0.4),transparent_60%)]" />
                    </div>
                  </div>
                </div>
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <div className="grid items-center gap-10 sm:gap-12 md:grid-cols-2">
            ...
            {/* RIGHT: Guardrails mock */}
            <motion.div {...fadeIn} className="flex justify-center">
              <div className="relative w-full max-w-xl rounded-2xl border border-emerald-400/40 bg-gradient-to-b from-[#031814] via-[#020910] to-black p-4 sm:p-5 shadow-[0_32px_110px_rgba(0,0,0,1)]">
                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                  <div className="h-3.5 sm:h-4 w-24 sm:w-28 rounded bg-emerald-500/60" />
                  <div className="h-3.5 sm:h-4 w-10 sm:w-12 rounded bg-zinc-800" />
                </div>

                <div className="grid grid-cols-3 gap-2 sm:gap-3 text-[11px] text-slate-200">
                  {['RBAC', 'Guardrails', 'Audit log'].map((label) => (
                    <div key={label} className="rounded-xl border border-white/12 bg-black/70 p-2 sm:p-3">
                      <div className="mb-1 text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-200">
                        {label}
                      </div>
                      <div className="h-2.5 sm:h-3 w-full rounded bg-zinc-700" />
                      <div className="mt-1.5 sm:mt-2 h-1.5 sm:h-2 w-4/5 rounded bg-zinc-800" />
                    </div>
                  ))}
                </div>

                <div className="mt-3 sm:mt-4 flex items-center gap-2 text-[10px] text-slate-400">
                  <span className="h-px flex-1 bg-gradient-to-r from-white via-emerald-400 to-transparent" />
                  <span className="whitespace-nowrap text-[9px] sm:text-[10px]">All prompts &amp; actions pass through policy layer</span>
                </div>

                <div className="mt-3 rounded-2xl border border-[rgba(25,226,143,0.85)] bg-black/80 p-3 sm:p-4">
                  <div className="mb-2 flex items-center justify-between">
                    <div className="h-2.5 sm:h-3 w-20 sm:w-24 rounded bg-zinc-700" />
                    <div className="flex gap-1.5">
                      <span className="h-2 w-2 rounded-full bg-emerald-400" />
                      <span className="h-2 w-2 rounded-full bg-amber-300" />
                    </div>
                  </div>
                  <div className="space-y-1 sm:space-y-1.5 text-[10px] text-zinc-200">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex items-center justify-between">
                        <span className="h-1.5 sm:h-2 w-20 sm:w-24 rounded bg-zinc-800" />
                        <span className="h-1.5 sm:h-2 w-8 sm:w-10 rounded bg-zinc-900" />
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          ...
          <motion.div {...fadeIn} className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {[
              {
                title: 'Operations & NOC',
                body: 'Speed up incident triage, reduce MTTR and keep on-call teams in the loop.',
              ...
              <div
                key={item.title}
                className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 via-black/40 to-black/80 p-4 sm:p-5 text-left shadow-[0_24px_80px_rgba(0,0,0,0.9)]"
              >
                <h3 className="text-sm font-semibold text-white">{item.title}</h3>
                <p className="mt-2 text-sm text-slate-300/85">{item.body}</p>
              </div>
        ...
        <section className="mt-20 sm:mt-24 md:mt-32 mx-auto max-w-6xl px-5 sm:px-8 md:px-10 lg:px-16">
          <motion.div
            {...fadeIn}
            className="grid items-center gap-8 sm:gap-10 rounded-3xl border border-white/10 bg-gradient-to-r from-[#020b08] via-[#020815] to-black px-5 sm:px-6 py-8 sm:py-10 md:grid-cols-2 md:px-10"
          >
            {/* Text */}
            <div>
              <p
              ...
              <div className="mt-6 sm:mt-7 flex flex-wrap items-center gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-full px-6 sm:px-7 py-2.5 sm:py-3 text-sm font-medium text-black shadow-[0_0_40px_rgba(25,226,143,0.8)] transition-transform duration-200 hover:-translate-y-0.5 active:scale-95"
                  style={{ backgroundColor: ACCENT }}
                >
                  Connect now
                  <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-black/10 text-xs">
              ...
              <div className="relative w-full max-w-sm sm:max-w-md rounded-2xl border border-white/10 bg-gradient-to-b from-[#18181b] via-[#020617] to-black p-3 sm:p-4 shadow-[0_32px_110px_rgba(0,0,0,1)]">
                ...
                <div className="grid grid-cols-5 gap-2 sm:gap-3">
                  ...
                  <div className="col-span-3 space-y-1.5 sm:space-y-2">
                    ...
                    <div className="h-16 sm:h-24 rounded-xl bg-[radial-gradient(circle_at_20%_20%,rgba(25,226,143,0.25),transparent_55%),radial-gradient(circle_at_80%_70%,rgba(56,189,248,0.25),transparent_55%)]" />
                ...
                <div className="mt-3 sm:mt-4 flex items-center justify-between">
                  ...
                  <div className="flex gap-1.5 sm:gap-2">
                    <div
                      className="h-6 sm:h-7 w-14 sm:w-16 rounded-full"
