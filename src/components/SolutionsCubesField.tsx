// // src/app/components/SolutionsCubesField.tsx
// 'use client';
...
// export default function SolutionsCubesField() {
//   const ROWS = 4;
//   const COLS = 10;
...
//     // Fisher–Yates shuffle for staggered reveal
...
//       {/* Heading + description for Solutions */}
...
//           }}
//         >
//           Every solution here is built to run 24×7 — designed around real-world
//           rollout constraints, operations, safety and long-term support. Explore
//           how we combine infrastructure, software and managed services for each
//           area.
//         </p>

//         {/* small chips for each solution family */}
...
//   useEffect(() => {
//     const update = () => setCols(window.innerWidth < 640 ? 5 : 10);
//     update();
...
//   return (
//     <div className="relative w-full overflow-hidden bg-[#050506]" style={{ minHeight: '100svh' }}>
//       {/* Cubes grid */}
//       <div className="relative mx-auto flex h-full max-w-[1400px] flex-col justify-center gap-3 px-3 sm:gap-6 sm:px-6 md:px-8 lg:px-16">
//         <div className="w-full space-y-3 sm:space-y-4">
//           {Array.from({ length: ROWS }).map((_, rowIndex) => {
//             const rowAmplitude = 20 + rowIndex * 6;
//             const rowDuration = 6 + rowIndex * 0.6;
...
//                     <motion.div
//                       key={colIndex}
//                       className="relative aspect-square overflow-visible rounded-xl sm:rounded-2xl border"
//                       style={{
//                         backgroundColor: '#141515',
//                         borderColor: 'rgba(255,255,255,0.05)',
//                       }}
...
//                       animate={{ opacity: targetOpacity, scale: 1 }}
//                       transition={{
//                         opacity: { delay: appearDelay, duration: 0.6, ease: [0.22, 1, 0.36, 1] },
//                         scale: { delay: appearDelay, duration: 0.6, ease: [0.22, 1, 0.36, 1] },
//                       }}
//                     >
//                       <div className="flex h-full items-center justify-center">
//                         <Image
//                           src={icon.src}
//                           alt={icon.alt}
//                           className="h-5 w-5 sm:h-7 sm:w-7 md:h-8 md:w-8 opacity-80"
//                         />
//                       </div>
//                     </motion.div>
//                   );
...
//       >
//         <div
//           className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.9)]"
//           style={{
...
//               style={{ width: 'clamp(28px, 6vw, 48px)', height: 'clamp(28px, 6vw, 48px)' }}
//             />
//           </div>
//         </div>
//       </motion.div>
...
//       {/* Heading + description */}
//       <div
//         className="pointer-events-none absolute inset-x-0 z-10 flex flex-col items-center px-4 text-center sm:px-6"
//         style={{ top: '54%' }}
//       >
//         <p className="mb-3 inline-flex items-center rounded-full border border-sky-400/60 bg-sky-400/15 px-4 py-1 text-[11px] sm:text-[13px] font-semibold uppercase tracking-[0.22em] text-sky-200">
//           Solutions
//         </p>

//         <h2
//           className="max-w-5xl text-[28px] font-medium leading-tight text-white sm:text-[40px] md:text-[48px] lg:text-[54px]"
//           style={{
//             fontFamily:
//               '"ABC Diatype",-apple-system,system-ui,"Segoe UI",Roboto,Inter,"Helvetica Neue",Arial',
//           }}
...
//         <p
//           className="mt-3 max-w-3xl text-xs text-[#9CA3AF] sm:text-sm md:text-base"
//           style={{
//             fontFamily:
//               '"ABC Diatype",-apple-system,system-ui,"Segoe UI",Roboto,Inter,"Helvetica Neue",Arial',
//           }}
//         >
//           Every solution here is built to run 24×7 — designed around real-world
//           rollout constraints, operations, safety and long-term support.
//         </p>

//         <div className="mt-3 flex flex-wrap justify-center gap-2 text-[10px] sm:text-[11px] text-slate-200">
//           <span className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-black/40 px-2.5 sm:px-3 py-1">
//             <span className="h-1.5 w-1.5 rounded-full bg-sky-400" />
//             Core network fabric
//           </span>
//           <span className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-black/40 px-2.5 sm:px-3 py-1">
...
export default function SolutionsCubesField() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#050506]">
      ...
      {/* ── GRID + ICON: grid sets height, icon centered inside ── */}
      <div className="relative w-full">
        {/* Cubes grid */}
        <div className="relative mx-auto max-w-[1400px] px-3 pt-4 sm:px-6 sm:pt-6 md:px-8 lg:px-16">
        ...
        {/* Vignettes scoped to grid area */}
        <div className="pointer-events-none absolute inset-0 z-10 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0)_0%,rgba(0,0,0,0.55)_50%,rgba(0,0,0,0.95)_65%,rgba(0,0,0,1)_100%)]" />
        <div className="pointer-events-none absolute inset-0 z-10 bg-[linear-gradient(to_right,rgba(0,0,0,1),rgba(0,0,0,0.75)_8%,rgba(0,0,0,0)_20%,rgba(0,0,0,0)_80%,rgba(0,0,0,0.75)_92%,rgba(0,0,0,1))]" />
        <div className="pointer-events-none absolute inset-x-0 top-0 z-10 h-20 bg-gradient-to-b from-black/80 to-transparent" />
      </div>

      {/* ── HERO TEXT: flows naturally below grid ── */}
      <div className="relative z-10 flex flex-col items-center px-4 pb-10 pt-5 text-center sm:px-6 sm:pb-14 sm:pt-6">
        <p className="mb-3 inline-flex items-center rounded-full border border-sky-400/60 bg-sky-400/15 px-4 py-1 text-[11px] sm:text-[13px] font-semibold uppercase tracking-[0.22em] text-sky-200">
          Solutions
        </p>
        ...
        <div className="mt-3 flex flex-wrap justify-center gap-2 text-[10px] sm:text-[11px] text-slate-200">
          {[
            { label: 'Core network fabric', color: 'bg-sky-400' },
            { label: 'Optimised WAN', color: 'bg-emerald-400' },
            { label: 'Zero-trust security', color: 'bg-fuchsia-400' },
            { label: 'Hybrid & media cloud', color: 'bg-amber-300' },
            { label: 'Wi-Fi & outdoor', color: 'bg-cyan-300' },
            { label: 'Rooms & live', color: 'bg-rose-300' },
          ].map(({ label, color }) => (
            <span key={label} className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-black/40 px-2.5 sm:px-3 py-1">
