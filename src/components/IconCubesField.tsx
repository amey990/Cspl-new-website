...
// // orb Lottie JSON (update path if your file lives somewhere else)
// import orbAnimation from '../../assets/lottie/orb-bubble.json';
...
//             const rowAmplitude = 40 + rowIndex * 10; // pixels
...
//       {/* Foreground hero cube with same style + Lottie orb inside */}
//       <motion.div
//         // className="pointer-events-none absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2"
//         className="pointer-events-none absolute left-1/2 top-[40%] md:top-[35%] z-20 -translate-x-1/2 -translate-y-1/2"
//         initial={{ opacity: 0, scale: 0.7, y: 20 }}
//         animate={{ opacity: 1, scale: 1, y: 0 }}
//         transition={{
//           delay: 1.2, // pops in after most background cubes
//           duration: 0.9,
//           ease: [0.22, 1, 0.36, 1],
//         }}
//       >
...
//       {/* Hero heading + subtext below the hero cube */}
      
//       {/* <div className="pointer-events-none absolute inset-x-0 top-1/2 z-10 flex flex-col items-center px-6 text-center translate-y-[140px] md:translate-y-[170px]"> */}
//       <div className="pointer-events-none absolute inset-x-0 top-[55%] md:top-[57%] z-10 flex flex-col items-center px-6 text-center">

//         <h2
//           className="text-[52px] font-medium text-white md:text-[58px] leading-tight"
//           style={{
//             fontFamily:
//               '"ABC Diatype",-apple-system,system-ui,"Segoe UI",Roboto,Inter,"Helvetica Neue",Arial',
//           }}
//         >
//           {/* Products built for modern media workflows */}
//           Powering Your Next Big Leap
//         </h2>
//         <p
...
export default function IconCubesField() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#050506]">
      ...
      {/* ── GRID + ORB: grid sets height, orb is centered inside it ── */}
      <div className="relative w-full">
        ...
        >
          ...
          >
            <div className="pointer-events-auto flex h-full w-full items-center justify-center">
              <Lottie animationData={orbAnimation} loop autoplay className="h-[120%] w-[120%]" />
            </div>
          </div>
        </motion.div>
      ...
      {/* ── HERO TEXT: flows naturally below grid, zero extra gap ── */}
      <div className="relative z-10 flex flex-col items-center px-4 pb-10 pt-5 text-center sm:px-6 sm:pb-14 sm:pt-6">
        <h2
          className="text-[30px] font-medium text-white sm:text-[42px] md:text-[52px] lg:text-[58px] leading-tight"
          style={{
            fontFamily:
              '"ABC Diatype",-apple-system,system-ui,"Segoe UI",Roboto,Inter,"Helvetica Neue",Arial',
          }}
        ...
        <p
          className="mt-3 max-w-2xl text-xs text-[#9CA3AF] sm:text-sm md:text-base"
          style={{
            fontFamily:
              '"ABC Diatype",-apple-system,system-ui,"Segoe UI",Roboto,Inter,"Helvetica Neue",Arial',
          }}
